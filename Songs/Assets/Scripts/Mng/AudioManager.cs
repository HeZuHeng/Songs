...
public class AudioManager : MonoBehaviour
{
    ...
    private AudioSource jiaobuAudioSource;
    ...
    void Awake()
    {
        ...
        jiaobuAudioSource = gameObject.AddComponent<AudioSource>();
    ...
    public void PlayJiaobuSound(int id, bool play, float volume = 1)
    {
        if (jiaobuAudioSource.isPlaying)
        {
            if(!play)jiaobuAudioSource.Stop();
        }
        else
        {
            if(play)
            {
                jiaobuAudioSource.clip = GetAudioClip(id);
                jiaobuAudioSource.clip.LoadAudioData();
                jiaobuAudioSource.loop = true;
                jiaobuAudioSource.volume = musicVolume;
                jiaobuAudioSource.Play();
            }
        }
    }
    ...
    /// </summary>
    /// <param name="id"></param>
    public void PlaySound(int id, float volume = 1, Action action = null)
    {
