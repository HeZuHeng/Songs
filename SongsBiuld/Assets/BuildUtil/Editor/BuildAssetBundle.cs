...
public class BuildAssetBundle
{
    ...
    [MenuItem("Tools/MarkSelections", false, 3)]
    public static void MarkSelects()
    {
        SetAssetBundlesName(OutPutPrefabsPath+ "/Sound/华兹华斯录音");
        SetAssetBundlesName(OutPutPrefabsPath + "/Sound/惠特曼录音");
    }
